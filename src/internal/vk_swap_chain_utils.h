/*
  ...
  @file src/internal/vk_swap_chain_utils.h
...
*/
inline static Moss__SwapChainSupportDetails moss__query_swap_chain_support (VkPhysicalDevice device, VkSurfaceKHR surface)
{
...
*/
inline static void moss__free_swap_chain_support_details (Moss__SwapChainSupportDetails *details)
{
...
*/
inline static VkSurfaceFormatKHR moss__choose_swap_surface_format (const VkSurfaceFormatKHR *available_formats, uint32_t format_count)
{
...
*/
inline static VkPresentModeKHR moss__choose_swap_present_mode (const VkPresentModeKHR *available_present_modes, uint32_t present_mode_count)
{
...
*/
inline static VkExtent2D moss__choose_swap_extent (const VkSurfaceCapabilitiesKHR *capabilities, uint32_t width, uint32_t height)
{
